...
/* SHA-1 */
__always_inline int SHA1Reset (SHA1Context *);
__always_inline int SHA1Input (SHA1Context *, const uint8_t * bytes,
                               unsigned int bytecount);
__always_inline int SHA1FinalBits (SHA1Context *, const uint8_t bits,
                                   unsigned int bitcount);
__always_inline int SHA1Result (SHA1Context *, uint8_t Message_Digest[SHA1HashSize]);

/* SHA-224 */
__always_inline int SHA224Reset (SHA224Context *);
__always_inline int SHA224Input (SHA224Context *, const uint8_t * bytes,
                                 unsigned int bytecount);
__always_inline int SHA224FinalBits (SHA224Context *, const uint8_t bits,
                                     unsigned int bitcount);
__always_inline int SHA224Result (SHA224Context *,
                                  uint8_t Message_Digest[SHA224HashSize]);

/* SHA-256 */
__always_inline int SHA256Reset (SHA256Context *);
__always_inline int SHA256Input (SHA256Context *, const uint8_t * bytes,
                                 unsigned int bytecount);
__always_inline int SHA256FinalBits (SHA256Context *, const uint8_t bits,
                                     unsigned int bitcount);
__always_inline int SHA256Result (SHA256Context *,
                                  uint8_t Message_Digest[SHA256HashSize]);

/* SHA-384 */
__always_inline int SHA384Reset (SHA384Context *);
__always_inline int SHA384Input (SHA384Context *, const uint8_t * bytes,
                                 unsigned int bytecount);
__always_inline int SHA384FinalBits (SHA384Context *, const uint8_t bits,
                                     unsigned int bitcount);
__always_inline int SHA384Result (SHA384Context *,
                                  uint8_t Message_Digest[SHA384HashSize]);

/* SHA-512 */
__always_inline int SHA512Reset (SHA512Context *);
__always_inline int SHA512Input (SHA512Context *, const uint8_t * bytes,
                                 unsigned int bytecount);
__always_inline int SHA512FinalBits (SHA512Context *, const uint8_t bits,
                                     unsigned int bitcount);
__always_inline int SHA512Result (SHA512Context *,
                                  uint8_t Message_Digest[SHA512HashSize]);

/* Unified SHA functions, chosen by whichSha */
__always_inline int USHAReset (USHAContext *, SHAversion whichSha);
__always_inline int USHAInput (USHAContext *,
                               const uint8_t * bytes, unsigned int bytecount);
__always_inline int USHAFinalBits (USHAContext *,
                                   const uint8_t bits, unsigned int bitcount);
__always_inline int USHAResult (USHAContext *,
                                uint8_t Message_Digest[USHAMaxHashSize]);
__always_inline int USHABlockSize (enum SHAversion whichSha);
__always_inline int USHAHashSize (enum SHAversion whichSha);
__always_inline int USHAHashSizeBits (enum SHAversion whichSha);
 ...
 */
__always_inline int hmac (SHAversion whichSha,	/* which SHA algorithm to use */
 ...
 */
__always_inline int hmacReset (HMACContext * ctx, enum SHAversion whichSha,
                               const unsigned char *key, int key_len);
__always_inline int hmacInput (HMACContext * ctx, const unsigned char *text,
                               int text_len);

__always_inline int hmacFinalBits (HMACContext * ctx, const uint8_t bits,
                                   unsigned int bitcount);
__always_inline  int hmacResult (HMACContext * ctx, uint8_t digest[USHAMaxHashSize]);
...
static __always_inline void SHA1Finalize (SHA1Context * context, uint8_t Pad_Byte);
static __always_inline void SHA1PadMessage (SHA1Context *, uint8_t Pad_Byte);
static __always_inline void SHA1ProcessMessageBlock (SHA1Context *);
...
/* Local Function Prototypes */
static __always_inline void SHA224_256Finalize (SHA256Context * context, uint8_t Pad_Byte);
static __always_inline void SHA224_256PadMessage (SHA256Context * context, uint8_t Pad_Byte);
static __always_inline void SHA224_256ProcessMessageBlock (SHA256Context * context);
static __always_inline int SHA224_256Reset (SHA256Context * context, uint32_t * H0);
static __always_inline int SHA224_256ResultN (SHA256Context * context,
...
/* Local Function Prototypes */
static __always_inline void SHA384_512Finalize (SHA512Context * context, uint8_t Pad_Byte);
static __always_inline void SHA384_512PadMessage (SHA512Context * context, uint8_t Pad_Byte);
static __always_inline void SHA384_512ProcessMessageBlock (SHA512Context * context);
static __always_inline int SHA384_512Reset (SHA512Context * context, uint32_t H0[]);
static __always_inline int SHA384_512ResultN (SHA512Context * context,
			      uint8_t Message_Digest[], int HashSize);
...
static __always_inline void SHA384_512PadMessage (SHA512Context * context, uint8_t Pad_Byte);
static __always_inline void SHA384_512ProcessMessageBlock (SHA512Context * context);
static __always_inline int SHA384_512Reset (SHA512Context * context, uint64_t H0[]);
static __always_inline int SHA384_512ResultN (SHA512Context * context,
                                              uint8_t Message_Digest[], int HashSize);
